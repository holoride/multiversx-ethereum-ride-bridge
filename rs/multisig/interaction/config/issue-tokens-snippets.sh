...
issueChainSpecificToken() {
    ...
    CHAIN_SPECIFIC_TOKEN_TICKER NR_DECIMALS_CHAIN_SPECIFIC CHAIN_SPECIFIC_TOKENS_TO_MINT
    
    VALUE_TO_MINT=$(echo "$CHAIN_SPECIFIC_TOKENS_TO_MINT*10^$NR_DECIMALS_CHAIN_SPECIFIC" | bc)
